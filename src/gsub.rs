...
#[derive(Debug, Clone)]
pub enum GsubTable<'a> {
    GsubVersion1_0(GsubVersion1_0<'a>),
    GsubVersion1_1(GsubVersion1_1<'a>),
}

#[repr(C)]
#[derive(Debug, Clone)]
pub struct GsubVersion1_0<'a> {
